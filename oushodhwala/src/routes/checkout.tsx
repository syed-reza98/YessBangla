...
import { getMyLoyaltyAction, redeemLoyaltyAction } from "@/actions/loyalty";
import { saveOrderLocationAction } from "@/actions/admin-ops";
...
function Checkout() {
  ...
  const { data: loyalty } = useQuery({
    ...
    queryFn: async () => {
      ...
      const tier = balance >= 5000 ? "platinum" : balance >= 1000 ? "gold" : "silver";
      return { balance, tier };
    },
  });
